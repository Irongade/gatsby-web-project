...
const HomeBanner = ({onCursorHover}) => {
    ...
    return (
        <Banner>
            ...
            <Canvas id="canvas" height={size.height} width={size.width} ref={canvasRef} onMouseEnter={() => onCursorHover("hovered")} onMouseLeave={onCursorHover} />
